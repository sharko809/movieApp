...
public class ReviewValidator implements Validator {
    ...
    public List<String> validate(Object object) {
        ...
        if (!(object instanceof Review)) {
            ...
            LOGGER.error("Attempt to validate invalid object in review validator: Object: " + object.getClass());
            return errors;
        }
        ...
        if (review.getTitle() != null || !(review.getTitle().isEmpty())) {// TODO may be add regex
